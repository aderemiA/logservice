...
const accessSecret = process.env.CUSTIGROW_TOKEN_ACCESS_SECRET;
const refreshSecret = process.env.CUSTIGROW_TOKEN_REFRESH_SECRET;

exports.generateAccessToken = async (payload) => {
  const options = {
    expiresIn: process.env.CUSTIGROW_TOKEN_ACCESS_EXPIRES_M,
  };
...
exports.generateRefreshToken = async (payload) => {
  const options = {
    expiresIn: process.env.CUSTIGROW_TOKEN_REFRESH_EXPIRES_M,
  };
